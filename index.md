...
<iframe src="javascript:document.write('<body style=margin:0;padding:0px;font-size:3.0rem;overflow:hidden;>today: ' +new Date().getFullYear() +'-' + +(new Date().getMonth() +1) +'-' +new Date().getDate() +'</body>')" style="height:4.0rem; width:60.0rem;border-style:none;"></iframe>
