...
<!--[NOWRITING]-->
<link rel="canonical" href="https://wraith13.github.io/writing/?@usage.md" />
この markdown の表示用URL: <a rel="canonical" href="https://wraith13.github.io/writing/?@usage.md">https://wraith13.github.io/writing/?@usage.md</a>
<!--[/NOWRITING]-->
<!--
class: center, middle
-->
...
**⚠ 現状、全然まだドキュメント書いてないし、この usage の記述すら全然追いついてません。。。**
...
この usage は markdown としてもスライドとしても表示できます

- [markdown(marked)](https://wraith13.github.io/writing/?@usage.md)
- [markdown(commonmark)](https://wraith13.github.io/writing/?commonmark&@usage.md)
- [markdown(markdown-it)](https://wraith13.github.io/writing/?markdown-it&@usage.md)
- [スライド(remark)](https://wraith13.github.io/writing/?remark&@usage.md)
- [スライド(reveal)](https://wraith13.github.io/writing/?reveal&@usage.md)
...
> この usage.md では使用していませんが remark において CSS クラスを指定する `.class[ テキスト ]` のような指定は markdown として表示される際にそのまま表示されてしまいますが、これは潔く諦めましょう。
